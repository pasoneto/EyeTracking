...
\begin{tabular}{|c|L|L|}
    ...
    tea & \multicolumn{1}{m{10cm}|}{Diagnóstico. TEA, TD, ou nonTD. TD indica Tipical Development. \textit{(P)}.}    \\
    \hline
...
\begin{tabular}{|c|L|L|}
    ...
    dataNascimento & \multicolumn{1}{m{10cm}|}{Data de nascimento \textit{(P)}.}    \\
    \hline

    pontuacaoCARS & \multicolumn{1}{m{10cm}|}{Pontuação obtida no CARS. \textit{(P)}.}    \\
    \hline

    sexo & \multicolumn{1}{m{10cm}|}{Sexo Masculino ou Feminino. \textit{(P)}.}    \\
    \hline

    ageCARS & \multicolumn{1}{m{10cm}|}{Idade do participante no dia em que foi feito o CARS (dataCARS - dataNascimento). \textit{(P)}.}    \\
    \hline

    ageJA & \multicolumn{1}{m{10cm}|}{Idade do participante no dia em que foi feito o JA (dataJA - dataNascimento). \textit{(P)}.} \\
    \hline

    timeBetweenJAandCARS & \multicolumn{1}{m{10cm}|}{Dias entre administração do JA e do CARS (|dataJA - dataNascimento|). \textit{(P)}.} \\
    \hline
